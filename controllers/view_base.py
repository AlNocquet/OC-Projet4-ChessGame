...
class BaseView:
    """Creates BaseView object wich manages all formats and
    characteristics of the user's requests."""
    ...
    def round_sections_settings(self, msg: str):
        """Settings the title and layouts of rounds section"""
        print("\n" + Fore.YELLOW + Style.BRIGHT + msg.center(100))

    def match_players_settings(self, msg: str):
        """Settings the display of pair of player for view_tournament which uses it"""
        print("\n" + Fore.WHITE + Style.DIM + msg)

    def match_scores_settings(self, msg: str):
        """Settings the display of score's choice for view_tournament which uses it"""
        print("\n" + Fore.WHITE + Style.DIM + msg)
    ...
    def table_settings(self, headers, title: str, items: list):
        ...
        for item in items:
            # Conversion of any int into strings for compatibility with Table rendering
    ...
    def get_user_answer(self, label):
        """Displays field "Enter your choice" and returns the user's response"""
    ...
    def get_alpha_string(self, label: str) -> str:
        """Returns a value compatible with an alphastring and a value > 0"""
